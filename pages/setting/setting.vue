		...
		<view class="setting_info">
			...
			<view class="basic_info">
				...
				<view class="info_item">
					...
					<u--input placeholder="请输入昵称" border="none" inputAlign="right" v-model="userInfo.name"
						fontSize="26rpx" disabled="false" style="padding-right: 25rpx;"></u--input>
				</view>

				<view class="info_item">
					<text style="padding-left: 35rpx;">真实姓名</text>
					<u--input border="none" inputAlign="right" v-model="userInfo.realName" fontSize="26rpx"
						:disabled="inputStatus" style="padding-right: 25rpx;"></u--input>
				</view>
				<view class="info_item">
					<text style="padding-left: 35rpx;">身份证号</text>
					<u--input border="none" inputAlign="right" v-model="userInfo.idCrad" fontSize="26rpx"
						:disabled="inputStatus" style="padding-right: 25rpx;"></u--input>
				</view>
				<view class="info_item">
					<text style="padding-left: 35rpx;">电话号码</text>
					<u--input placeholder="请输入电话号码" border="none" inputAlign="right" v-model="userInfo.phone"
						fontSize="26rpx" :disabled="inputStatus" style="padding-right: 25rpx;"></u--input>
				</view>
			</view>
			...
			<view class="" v-if="identify=='driver'">
				...
				<view class="authentication_info">
					<view class="info_item">
						...
						<u--input border="none" inputAlign="right" v-model="userInfo.licensePlate" fontSize="30rpx"
							:disabled="inputStatus" class="input_right"></u--input>
					</view>
					<view class="info_item">
						<text style="padding-left: 40rpx;">车型</text>
						<u--input border="none" inputAlign="right" v-model="userInfo.carType" fontSize="30rpx"
							:disabled="inputStatus" class="input_right"></u--input>
					</view>
				</view>
			</view>
			...
			<view class="" v-else>
				...
				<view class="authentication_info">
					<view class="info_item">
						...
						<u--input placeholder="请输入公司名称" border="none" inputAlign="right" v-model="userInfo.company"
							fontSize="26rpx" :disabled="inputStatus" style="padding-right: 25rpx;"></u--input>
					</view>
					<view class="info_item">
						<text style="padding-left: 35rpx;">公司地址</text>
						<u--input placeholder="请输入公司地址" border="none" inputAlign="right" v-model="userInfo.address"
							fontSize="26rpx" :disabled="inputStatus" style="padding-right: 25rpx;"></u--input>
					</view>
				</view>
			</view>
			...
			<view class="other_info">
				...
				<u-cell-group class="setting-list" :border="false">
					<u-cell class="setting-item" title="角色切换" @click="Reroles" isLink></u-cell>
				</u-cell-group>
			</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			//重设角色
			Reroles() {				
				console.log("点击重设角色",this.$store.state.userInfo.roles+";"+uni.getStorageSync('identify'));
				if (uni.getStorageSync('identify') == "driver") {
					uni.setStorageSync('identify', 'user')
					uni.reLaunch({
						url: "/pages/index/index"
					})
				} else if (this.$store.state.userInfo.roles == 'driver' && uni.getStorageSync('identify') == "user") {
