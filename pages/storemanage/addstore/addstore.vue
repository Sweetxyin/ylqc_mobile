<template>
	<view class="container">
		...
		<view class="map">
			<!-- <Map></Map> -->
			<map @tap="getMapLocation" style="width: 100vw; height: 650rpx;" :latitude="reportInfo.lttd"
				:longitude="reportInfo.lgtd" show-location :markers="covers" enable-3D="true" >
			</map>
		</view>
...
<script>
	...
	export default {
		...
		onLoad(option) { 
			...
			self.getAuthorize(); // 页面第一次加载时就会触发这个方法
			// uni.getStorage({
			// 	key:'local',
			// 	success(res){
