		...
		<view class="store_address">
			<view class="address_top">
				<view class="address_name">
					<text style="padding-left: 15rpx;">{{receLocation.addressName}}</text>
				</view>
			...
			<view class="address_bottom">
				<text>{{receLocation.address}}</text>
			</view>
		...
		<view class="strore_item">
			<view class="list">
				...
				<u--input placeholder="楼层及门牌号码" border="none" inputAlign="right"
				   v-model="receLocation.addressNotes" fontSize="32rpx" style="padding-right: 15rpx;"
				 ></u--input>
			</view>
			<view class="list">
				<text style="padding-left: 15rpx;">联系人</text>
				<u--input placeholder="姓名" border="none" inputAlign="right"
				   v-model="receLocation.contactName" fontSize="32rpx" style="padding-right: 15rpx;"
				 ></u--input>
			</view>
			<view class="list">
				<text style="padding-left: 15rpx;">联系电话</text>
				<u--input placeholder="联系电话" border="none" inputAlign="right"
				   v-model="receLocation.cantactPhone" fontSize="32rpx" style="padding-right: 15rpx;"
				 ></u--input>
			</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			conReceAddress(){
				uni.$emit('upReceData', this.receLocation)
				uni.navigateBack({
					delta: 1
				})				
			}
