<template>
	<view class="container">
		...
		<view class="month_bill">
			...
			<view v-show="month_current===1">
				<text style="font-size: 40rpx; font-weight: bold;padding-top: 25rpx;">￥{{monthsr_money}}</text>
			</view>
		</view>
		...
		<view class="year_bill">
			...
			<view class="bill_item">
				...
				<view class="" @click="year_show = true">
					<u-datetime-picker  :show="year_show" v-model="yearValue" mode="year-month" @confirm="confirm1" @cancel="close"></u-datetime-picker>
					<view>
						<text style="float: left; font-weight: bold;">{{ yearValue }}</text>
						<u-icon style="padding: 2rpx 0 0 5rpx;" name="arrow-down" size="18"></u-icon>
					</view>
				</view>
				<!-- 年账单支出收入选择器 -->
	...
	export default {
		data() {
			...
			return {
				...
				monthzc_sum:'0',//月账单支出总数
				moothzc_money:'0',//月账单支出金额
				monthsr_sum:'0',//月账单收入总数
				monthsr_money:'0',//月账单收入金额
				yearzc_sum:0,//年账单支出总数
				yearsr_sum:0,//年账单收入总数
				yearzc_money:0,//年账单支出金额
